...
set(_exported_libraries "livox_ros_driver2__rosidl_generator_c;livox_ros_driver2__rosidl_typesupport_c;livox_ros_driver2__rosidl_typesupport_cpp;livox_drive_lib")
  ...
  while(_i LESS _length)
    ...
    if(NOT _library_dirs)
      ...
      if(NOT _lib)
        # warn about not existing library and later ignore it
        message(WARNING
          "Package 'livox_ros_driver2' exports library '${_library_name}' with LIBRARY_DIRS '${_library_dirs}' which couldn't be found")
      endif()
    endif()
    if(_lib)
      list(APPEND livox_ros_driver2_LIBRARIES ${_cfg} "${_lib}")
