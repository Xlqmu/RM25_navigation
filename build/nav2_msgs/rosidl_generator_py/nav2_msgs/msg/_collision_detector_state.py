...
class Metaclass_CollisionDetectorState(type):
...
class CollisionDetectorState(metaclass=Metaclass_CollisionDetectorState):
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'polygons' field must be a set or sequence and each value of type 'str'"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'detections' field must be a set or sequence and each value of type 'bool'"
